            ...
            <table class="tbl-50">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                            ...
                            {
                                echo "<div class='fial'>Image not Available.</div>";
                            }
                        ?>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <input type="submit" name="submit" value ="Update Category" class="btn-prm">
                    </td> 
                </tr>
            </table>
        </form>
                    ...
                    if(isset($_FILES['image']['name']))
                    {
                        ...
                        {        
                            ...
                            if($current_image != "")
                            {
                                ...
                                if($remove == false)
                                {
                                    $_SESSION['remove'] = "<div calss='fail'>Failed to Remove Image.</div>";
                                    header('location:'.$siteurl.'admin/manage-food.php');
                                }
                            }
                        }
